        ...
        view.apply {
            ...
            adapter = GenericListAdapter(cameraList, itemLayoutId = layoutId) { view, item, _ ->
                ...
                view.setOnClickListener {
                    // LEGACY HAL FIX: Use parameterless method since navigation args have default values
                    // This will always use camera ID "0" and JPEG format for legacy HAL compatibility
